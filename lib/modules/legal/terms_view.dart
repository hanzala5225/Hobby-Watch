      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _body('Hobby Watch is a sports card collection tracking application that provides price data based on recent completed (sold) eBay listings for comparable cards. The App is intended to help collectors monitor the potential resale value of their sports card collections.'),
            _section('3. Price Data Disclaimer'),
            _body('Price data displayed in the App is sourced from recent completed eBay sales for comparable listings and represents an estimate based on those recent sales, not a guaranteed value for your specific card. This data is NOT guaranteed to be accurate, complete, or current. Hobby Watch does not guarantee any specific sale price for any card. Always conduct your own research before making buying or selling decisions.'),
