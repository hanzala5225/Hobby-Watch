...
class DashboardController extends GetxController {
  ...
  // Date-range activity filter (Tim's feature request, 2026-08-25). This is
  // an ACTIVITY report for the selected range — cards added/sold within it —
  // not a historical "what was my portfolio worth on day X" reconstruction,
  // since the app doesn't track portfolio value over time. See
  // ActivitySummaryResponse (backend) for the full reasoning.
